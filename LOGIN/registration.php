...
if (isset($_SESSION["user"])) {
   header("Location: /mssschools/givingsub.php");// This code checks whether the "user" session variable is set. If it is set, it means the user is already logged in, so the code redirects the user to the "index.php" page (which could be the main page of your website or any other page that you consider the default page for logged-in users)
}
?>
<!DOCTYPE html>
<html lang="en">
